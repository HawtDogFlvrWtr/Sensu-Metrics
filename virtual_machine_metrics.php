...
include '/temp/vmwarephp/library/Vmwarephp/Service.php';
include '/temp/vmwarephp/library/Vmwarephp/Vhost.php';
include '/temp/vmwarephp/library/Vmwarephp/WsdlClassMapper.php';
include '/temp/vmwarephp/library/Vmwarephp/SoapClient.php';
include '/temp/vmwarephp/library/Vmwarephp/ManagedObject.php';
include '/temp/vmwarephp/library/Vmwarephp/TypeConverter.php';
include '/temp/vmwarephp/library/Vmwarephp/Factory/ManagedObject.php';
include '/temp/vmwarephp/library/Vmwarephp/Factory/PropertyFilterSpec.php';
include '/temp/vmwarephp/library/Vmwarephp/Factory/Service.php';
include '/temp/vmwarephp/library/Vmwarephp/Factory/SoapClient.php';
include '/temp/vmwarephp/library/Vmwarephp/Factory/SoapMessage.php';
include '/temp/vmwarephp/library/Vmwarephp/Exception/CannotCreateSoapClient.php';
include '/temp/vmwarephp/library/Vmwarephp/Exception/InvalidTraversalPropertyFormat.php';
include '/temp/vmwarephp/library/Vmwarephp/Exception/InvalidVhost.php';
include '/temp/vmwarephp/library/Vmwarephp/Exception/Soap.php';
include '/temp/vmwarephp/library/Vmwarephp/Extensions/Datastore.php';
include '/temp/vmwarephp/library/Vmwarephp/Extensions/Folder.php';
include '/temp/vmwarephp/library/Vmwarephp/Extensions/PropertyCollector.php';
include '/temp/vmwarephp/library/Vmwarephp/Extensions/SessionManager.php';
include '/temp/vmwarephp/library/Vmwarephp/Extensions/VirtualMachine.php';
include '/temp/vmwarephp/library/Vmwarephp/TypeDefinitions.inc';
